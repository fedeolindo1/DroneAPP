...
if __name__ == "__main__":
    ...
    print("Usando versão MOCK da API?", USE_MOCK)
    ...
    print("\n=== Teste de geração de plano de missão ===")
    ...
    # Teste de mock simulando análise de imagem (sem imagem real)
    print("\n=== Teste de análise de imagem (mock) ===")
    image_analysis = controller.analyze_detected_objects("imagem_dummy_base64")
